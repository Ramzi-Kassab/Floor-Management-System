...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Address',
            fields=[
                ('party_type', models.CharField(choices=[('Customer', 'Customer'), ('Supplier', 'Supplier')], db_index=True, max_length=16)),
            ...
            options={
                ...
                'db_table': 'addresses',
                'ordering': ['party_type', 'party_id', '-is_primary'],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_primary', True)), fields=('party_type', 'party_id'), name='uq_address_primary_per_party')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'contacts',
                'ordering': ['party_type', 'party_id', '-is_primary'],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_primary', True)), fields=('party_type', 'party_id'), name='uq_contact_primary_per_party')],
            },
        ),
        migrations.CreateModel(
            name='CostCenter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_updated', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(blank=True, db_column='user_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employee_record', to=settings.AUTH_USER_MODEL)),
            ],
            options={
