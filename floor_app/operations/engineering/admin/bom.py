"""
BOM (Bill of Materials) Admin

Admin interface for managing BOMs for bit production, retrofit, and repair.

MOVED FROM: floor_app.operations.inventory.admin.bom
REASON: Engineering owns BOM definitions, not inventory
"""
